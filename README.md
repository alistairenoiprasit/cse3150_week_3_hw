...
### Minor Notes
Instead of writing all the logic in the main function, I created helper/facade 'functions' for what I would have written in the main function for the respective sections (ie AddStudentFacade would take inputs, and throw any errors prior to calling addStudent) just so it wouldn't get so bloated and convoluted.
